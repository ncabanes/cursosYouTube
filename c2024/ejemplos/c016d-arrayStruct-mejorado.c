/* Los "struct": contacto con los arrays de structs 
   (2, mejorado, con "fgets" y filtrando los saltos de línea) */
...
int main()
{
    ...
    for (i=0; i < 3; i++)
    {
        ...
        fgets(datos[i].nombre, 40, stdin);
        datos[i].nombre[ strlen(datos[i].nombre)-1 ] = '\0';
        printf("Año de nacimiento: ");
        scanf("%d", &datos[i].anyoNac);
        fgets(textoTemporal, 9, stdin);
    }
